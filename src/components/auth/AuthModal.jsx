        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" onClick={onClose}>
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-3">
                    ...
                    <button type="button" onClick={() => setError(tr('Đăng nhập bằng Google hiện chưa được cấu hình trên máy chủ. Vui lòng sử dụng Email/Mật khẩu để đảm bảo bảo mật.', 'Google login is not configured on the server. Please use Email/Password.', 'El inicio de sesión de Google no está configurado.', 'Google登录未配置。', 'Вход через Google не настроен.'))}
